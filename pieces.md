...
In these pages you can see some of the pieces I've been making. There aren't many, but they are quite distinct.
...
The shape is based on the cunca, traditionally used for broth. The design came from watching seaweed float in the water when I was sailing. The top section is left unpainted to show the clay, but it is glazed and perfectly safe to use.
